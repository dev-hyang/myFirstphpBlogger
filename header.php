<head>
	...
	<style type="text/css">
		...
		.morlink .footer {text-align: right; font: 65% arial, verdana, sans-serif}
		.morline {color: #993300}
		...
		<tr>
			<td valign="top" height="100" bgcolor="orange">
				...
				<div class="menu">
					...
					<br/>
					<br/>
					<a href="admin/index.php">I'm a writer</a>
				</div>
			</td>
			<td valign="top" width="100%">
				<p>
					<h1> Super Fast Online</h1>